...
\begin{frame}{Context}
    \begin{figure}[h]
        \includegraphics[height=0.9\textheight]{schema_stego0.pdf}
    \end{figure}
\end{frame}

\begin{frame}{Context}
    \begin{figure}[h]
        \includegraphics[height=0.9\textheight]{schema_stego.pdf}
    \end{figure}
\end{frame}

\begin{frame}{Context}
    \begin{figure}[h]
        \includegraphics[height=0.9\textheight]{schema_stego1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Context}
    \begin{figure}[h]
        \includegraphics[height=0.9\textheight]{schema_stego2.pdf}
    \end{figure}
