...
\begin{frame}{Context}
%\animategraphics[width=\linewidth]{25}{animation_stego_music/}{0}{29}
...
\begin{frame}{Context}
\begin{figure}[h]
\includegraphics[height=0.9\textheight]{images/schema_stego0.pdf}
\end{figure}
\end{frame}

\begin{frame}{Context}
\begin{figure}[h]
\includegraphics[height=0.9\textheight]{images/schema_stego.pdf}
\end{figure}
\end{frame}

\begin{frame}{Context}
\begin{figure}[h]
\includegraphics[height=0.9\textheight]{images/schema_stego1.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Context}
\begin{figure}[h]
\includegraphics[height=0.9\textheight]{images/schema_stego2.pdf}
\end{figure}
\pause
...
\begin{figure}[h]
\includegraphics[width=0.8\linewidth]{images/image_structure.pdf}
\end{figure}
    % \begin{center}
...
\begin{figure}[h]
\includegraphics[height=0.5\textheight]{images/formulaSTC.pdf}
\end{figure}
\pause
...
\begin{figure}[h]
%\hspace{-3em}
\centerline{\includegraphics[width=1\linewidth]{images/estonie_pipeline.pdf}}
\end{figure}
...
\begin{figure}
        \includegraphics[width=0.9\linewidth]{images/histograms.pdf}
\end{figure}

\end{frame}

\begin{frame}{Machine learning for automatic binary classification}
%\animategraphics[width=\linewidth]{25}{animation_training/}{0}{30}
\end{frame}
...
\begin{frame}{Adversarial steganography}
%\animategraphics[width=\linewidth]{25}{animation_adversarial_stego/}{0}{30}
\end{frame}


\begin{frame}{Adversarial steganography}
%\animategraphics[width=\linewidth]{25}{animation_retraining_stega/}{0}{30}
\end{frame}
...
\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_0.pdf}
\end{figure}
\end{frame}

\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_1.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_1_bis.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_2.pdf}
\end{figure}
\end{frame}

\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_2_bis.pdf}
\end{figure}
\end{frame}

\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_3.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_4.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Approximation with an iterative game}
  \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/increasing_game_5.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Results - How to read the plots }
    \begin{figure}
        \includegraphics[width=0.7\linewidth]{images/results3.pdf}
    \end{figure}
...
\begin{frame}{Results - Comparison of strategies for JPEG at QF 75 and different payloads (bpnzAC)}
    \begin{figure}
        \includegraphics[width=0.8\linewidth]{images/minmax_prot_1.pdf}
        \includegraphics[width=0.8\linewidth]{images/abcisses.pdf}
    \end{figure}
\end{frame}

\begin{frame}{Results - Comparison of strategies for JPEG at QF 75 and different payloads (bpnzAC)}
    \begin{figure}
        \includegraphics[width=0.8\linewidth]{images/minmax_prot_2.pdf}
        \includegraphics[width=0.8\linewidth]{images/abcisses.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Results - With different adversaries for JPEG QF 75, payload 0.4 bpnzAC}
    \begin{figure}
        \includegraphics[width=0.8\linewidth]{images/minmax_prot_3.pdf}
        \includegraphics[width=0.8\linewidth]{images/abcisses.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Flaws of ADV-EMB}
    ...
    \begin{itemize}
        ...
        \item At some point, it fails at solving
            ...
            \begin{figure}
                \includegraphics[width=0.9\linewidth]{images/minmax_evolution_it9.pdf}
             \end{figure}
...
\begin{frame}{1. Approximation of discrete modifications with Softmax Gumbel distribution}
    \begin{figure}[h]
        \includegraphics[width=0.8\linewidth]{images/ternarychanges_softmaxgumbel.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Difference between smooth and discrete stegos}
    \begin{figure}[h]
        \includegraphics[width=0.7\linewidth]{images/gradient_descent_purpose_tau.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Evolution of $\min\max$ protocol with Backpack}
    \begin{figure}
        \includegraphics[width=0.9\linewidth]{images/minmax_SGE_evolution_it7.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Results}
    ...
    \begin{figure}[h]
        \includegraphics[width=0.6\linewidth]{images/QF75_3models.pdf}
    \end{figure}
    \pause
    \begin{center}
        \begin{tabular}{ccccc}
...
Classifier using the rounding error of decompression~\footfullcite{butora2019reverse}
    \begin{figure}[h]
        \includegraphics[width=0.6\linewidth]{images/experience_512_100_0_01_SGE_exunet.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Interpretation - Natural correlations between DCT modes}
   ...
   \end{tabularx}
    ...
    \begin{figure}[h]
        \includegraphics[width=1\linewidth]{images/cov_BOSS.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Interpretation - Observed correlations between changes of DCT modes}
    ...
    \begin{figure}[h]
        \includegraphics[width=1\linewidth]{images/covariance_QF100_0_01_firstline.pdf}
    \end{figure}
...
\begin{frame}{Conclusion}
    \begin{itemize}
        ...
        \begin{figure}[h]
            \includegraphics[width=0.25\linewidth]{images/historicalgraph.pdf}
        \end{figure}
    \end{itemize}
...
\begin{frame}{Perspectives}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h]
            \includegraphics[width=0.4\linewidth]{images/experience_512_100_0_01_SGE_exunet.pdf}
        \end{figure}
...
\begin{frame}{Perspectives}
    ...
    \begin{figure}[h]
        \includegraphics[width=1\linewidth]{images/mismatch_payload.pdf}
    \end{figure}
